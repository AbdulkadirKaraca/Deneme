...
namespace Personel
{
    ...
    { 
        ...
        public void Kaydet()
        {
            OleDbCommand kaydet = new OleDbCommand("INSERT INTO Personel(Ad,Soyad,DogumTarihi,Adres,Sehir,Resim) VALUES ('"
                + txtAd.Text + "','" + txtSoyad.Text + "','" + txtDTarihi.Text + "','" + txtAdres.Text + "','" + txtSehir.Text + "','" + resimBox.Text + "')", conn);
   ...
   { 
    conn.Close(); 
     ...
     {
         OleDbCommand veri = new OleDbCommand("SELECT Numara, Ad, Soyad, DogumTarihi, Adres, Sehir,Resim FROM Personel where Numara="+ID+"", conn);
         OleDbDataReader oku=null;
         try
         {
             conn.Open();
             ...
             {resimBox.Enabled = false;
                 ...
                 resimBox.Text = oku["Resim"].ToString();
                 pictureBox1.Image = Image.FromFile(".\\resim\\" + resimBox.Text);
             }
         }
         catch (Exception ex)
         {
     ...
     public void Temizle()
     {
         ...
         txtAdres.Text = ""; txtSehir.Text = ""; txtDTarihi.Text = ""; resimBox.Text = "";
         txtAd.Focus(); 
